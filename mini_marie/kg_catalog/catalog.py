...
DOMAINS = [
    ...
    },
    {
        ...
        "cache": "mini_marie_cache/twa_city/city_cache.sqlite + pirmasens_ontop_cache.sqlite",
        "scale": "Bremen, Kaiserslautern, Pirmasens (CityGML + Pirmasens UBEM + Ontop toilet/plots/solar)",
    },
    {
        "id": "mops",
        "mcp_server": "twa-mops",
        ...
        "cache": "mini_marie_cache/mop_blazegraph/query_cache.sqlite",
        "scale": "~2.3k MOP polyhedra (remote Blazegraph)",
    },
    {
        "id": "sg_ontop",
        "mcp_server": "sg-old",
...
def kg_cache_status_text() -> str:
    ...
    checks = [
        ...
        root / "twa_city" / "pirmasens_ontop_cache.sqlite",
